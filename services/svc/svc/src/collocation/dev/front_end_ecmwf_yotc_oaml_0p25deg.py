...
class front_end_ecmwf_yotc_oaml_0p25deg():
	...
	self.longitude = N.where(new_var_lon > 180.0, new_var_lon - 360.0, new_var_lon)
        ...
        level_name = ['lv_HYBL3', 'lv_HYBL3_a', 'lv_HYBL3_b', 'lv_HYBL_i4_a', 'lv_HYBL_i4_b', 'P0']
        for i in range(len(level_name)):
            ...
            # add dimension name
            if (i<=2): 
                attribute['dimension1']='model_layer_midpoint'
            elif (i<=4):
                attribute['dimension1']='model_layer_interface'
            else: 
                attribute['dimension1']='dummy'
        ...
        #count_4D_variable = 0 # for debugging purpose
        ...
        for i in range(len(variableNames)):
          if(variableNames[i]!='initial_time0_encoded'
              ...
              # Fill in UT.NAN where data is the value defined by attribute '_FillValue'
                ...
                #count_4D_variable = count_4D_variable+1

                #if count_4D_variable>3: # for debugging purpose, let's end after a few variables
                #   break
              else:
