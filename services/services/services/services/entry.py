...
from services.src.twoDimMap import call_twoDimMap
...
@app.route('/services/twoDimMap', methods=["GET"])
@crossdomain(origin='*')
def display():
    ...
    try:
      ...
      output_dir = current_dir + '/services/static/' + tag
      print 'output_dir: ', output_dir
      if not os.path.exists(output_dir):
        os.makedirs(output_dir)

      # chdir to where the app is
      os.chdir(current_dir+'/services/src/twoDimMap')
